...
// đổi tên file này cho đúng với ảnh bạn lưu trong /src/assets/taxi
...
const TaxiHowItWorks: React.FC = () => {
  return (
    <section>
      <h4 className="fw-bold text-center mb-4">Đưa đón sân bay thật tiện lợi</h4>
