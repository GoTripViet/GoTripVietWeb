// src/components/BannerMobile.tsx
      ...
      <Container className="position-relative py-4">
        <div className="text-white">
          ...
          <div className="d-flex align-items-center gap-3">
            {qrUrl && <img src={qrUrl} alt="QR" loading="lazy" className="gv-qr" />}
            <div className="d-flex flex-column gap-2">
              {googlePlayBadgeUrl && <img src={googlePlayBadgeUrl} alt="Google Play" loading="lazy" className="gv-store-badge" />}
              {appStoreBadgeUrl && <img src={appStoreBadgeUrl} alt="App Store" loading="lazy" className="gv-store-badge" />}
            </div>
          </div>
        </div>
      </Container>
