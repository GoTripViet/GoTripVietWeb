...
import type { ListingCategory } from "../components/Listing.tsx";
import type { FaqItem } from "../components/Faq.tsx";
import type {GridLayoutItem} from "../components/GridLayout.tsx";
...
export const hotelsTopRated = [
  ...
  },
  {
    ...
    rating: 8.8,
    reviews: 876,
    extra: { kind: "A", category: "Resort", stars: 4 } as const,
  },
  {
    imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }),
...
export const hotels = [
  ...
  },
  {
    ...
    rating: 8.6,
    reviews: 688,
    extra: { kind: "B", note: "Bắt đầu từ", price: "836.000 VND" } as const,
  },
  {
    imageUrl: cld("hotel_saigon_g9dkyk", { w: 640, h: 480 }),
    ...
    rating: 9.3,
    reviews: 711,
    extra: { kind: "B", note: "Bắt đầu từ", price: "5.081.718 VND" } as const,
  },
  {
    ...
    rating: 9.0,
    reviews: 546,
    extra: { kind: "B", note: "Bắt đầu từ", price: "1.675.372 VND" } as const,
  },
];
...
export const hotelCategories: ListingCategory[] = [
  {
    id: "hotel_domestic",
...
export const planeCategories: ListingCategory[] = [
  {
    id: "plane_popular",
    label: "Thành phố trong nước",
    items: [
      { id: 1, title: "TP. Hồ Chí Minh -> Đà Nẵng", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 2, title: "TP. Hồ Chí Minh -> Phú Quốc", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 3, title: "TP. Hồ Chí Minh -> Singapore", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 4, title: "TP. Hồ Chí Minh -> Bangkok", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 5, title: "TP. Hồ Chí Minh -> Kuta", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 6, title: "TP. Hồ Chí Minh -> Tokyo", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 7, title: "TP. Hồ Chí Minh -> Siem Reap", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 8, title: "TP. Hồ Chí Minh -> Đài Bắc", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 9, title: "TP. Hồ Chí Minh -> Seoul", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 10, title: "TP. Hồ Chí Minh -> Kuala Lumpur", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
    ],
  },
  {
    id: "city",
    label: "Thành phố",
    items: [
      { id: 1, title: "TP. Hồ Chí Minh", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 2, title: "Hà Nội", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 3, title: "Đà Nẵng", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 4, title: "Nha Trang", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 5, title: "Phú Quốc", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 6, title: "Đà Lạt", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 7, title: "Hải Phòng", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 8, title: "Cần Thơ", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 9, title: "Huế", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 10, title: "Vũng Tàu", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 11, title: "Quy Nhơn", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
    ],
  },
  {
    id: "Nation",
    label: "Quốc gia",
    items: [
      { id: 1, title: "Thái Lan", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 2, title: "Singapore", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 3, title: "Malaysia", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 4, title: "Đài Loan", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 5, title: "Nhật Bản", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 6, title: "Hàn Quốc", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 7, title: "Indonesia", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 8, title: "Philippines", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 9, title: "Úc", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
      { id: 10, title: "Mỹ", imageUrl: cld("hotel_hanoi_x6by5r", { w: 640, h: 480 }) },
    ],
  },
];

export const activitiesCategories: ListingCategory[] = [
  {
    id: "tour",
    label: "Tour",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 2, title: "Khu bảo tồn động vật", description: "TP. Hồ Chí Minh" },
      { id: 3, title: "Vườn quốc gia", description: "Đà Nẵng" },
      { id: 4, title: "Khu du lịch sinh thái", description: "Nha Trang" },
      ...
      { id: 8, title: "Khu thể thao dưới nước", description: "Đà Lạt" },
    ],
  },
];
...
export const TAXI_FAQ_ITEMS: FaqItem[] = [
  {
    id: "flight-delay",
    ...
    answer: (
      <>
        ...
        chuyến bay của bạn và điều chỉnh thời điểm đón dựa vào giờ hạ cánh
        thực tế. Thông thường, tài xế sẽ đợi bạn đến 45 phút sau khi máy bay
        hạ cánh để bạn hoàn tất thủ tục hải quan, nhận hành lý và di chuyển ra
        khu vực đón khách.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Giá hiển thị đã bao gồm mọi chi phí cơ bản như lệ phí cầu đường,
        phụ phí, tiền tip và phí đường bộ. Nếu bạn đặt gói Meet &amp; Greet
        tiêu chuẩn, giá cũng bao gồm thời gian chờ lên đến 45 phút kể từ khi
        chuyến bay hạ cánh. Một số yêu cầu đặc biệt hoặc hành trình khác có
        thể phát sinh phụ phí riêng.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Tất cả dịch vụ xe riêng đều được thanh toán trước bằng thẻ hoặc ví
        điện tử khi đặt xe trực tuyến. Thanh toán được xử lý an toàn, chúng
        tôi chấp nhận hầu hết các loại thẻ tín dụng và ghi nợ phổ biến cũng như
        các hình thức thanh toán hợp lệ khác được hiển thị trên trang thanh
        toán.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Bạn thường có thể hủy đặt xe miễn phí cho tới 24 giờ trước thời điểm
        đón khách. Một số đối tác có thể cho phép hủy miễn phí trong khoảng
        thời gian ngắn hơn. Hãy kiểm tra lại điều kiện hủy trong email xác nhận
        đặt xe của bạn để biết chi tiết.
      </>
    ),
  },
];

export const RENTCAR_FAQ_ITEMS: FaqItem[] = [
  {
    id: "why-book-here",
    ...
    answer: (
      <>
        ...
        <ul>
          ...
          <li>
            Chính sách hủy linh hoạt – thường có thể hủy miễn phí trước giờ
            nhận xe theo điều kiện của từng đơn vị cho thuê.
          </li>
        </ul>
      </>
    ),
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          Phần lớn các công ty cho thuê xe yêu cầu người lái từ 21 tuổi trở
          lên; một số nơi có thể áp dụng độ tuổi tối thiểu hoặc tối đa khác
          nhau.
        </p>
        <p>
          Nếu người lái dưới một ngưỡng tuổi nhất định (ví dụ 25 tuổi), nhà
          cung cấp có thể tính thêm phụ phí tài xế trẻ tùy điều kiện cụ thể.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        thành, xe nhỏ gọn dễ đỗ và tiết kiệm nhiên liệu sẽ phù hợp. Nếu đi
        đường dài hoặc nhiều người, có thể cân nhắc xe rộng rãi hoặc SUV.
        <strong>Số người và hành lý:</strong> Hãy chọn xe đủ chỗ cho tất cả
        hành khách và hành lý của bạn.
        <strong>Điều kiện đường xá:</strong> Với các tuyến đường đèo, địa
        hình khó, hãy chọn xe mạnh hơn hoặc xe gầm cao nếu cần.
        <strong>Hộp số và nhiên liệu:</strong> Nếu quen lái số tự động, hãy
        chọn đúng loại hộp số; cân nhắc mức tiêu hao nhiên liệu cho hành
        trình dài.
      </>
    ),
  },
...
export const popularDestinations: GridLayoutItem[] = [
  {
    id: "danang",
    imageUrl: cld("cities_dalat_ipb25j", { w: 360, h: 270 }),
    title: "Đà Nẵng",
